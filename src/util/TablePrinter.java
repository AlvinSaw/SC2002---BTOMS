...
public class TablePrinter {
    ...
    /**
     * Converts a list of lists to a 2D String array
     * @param listData List of lists containing row data
     * @return 2D String array
     */
    public static String[][] convertListToArray(List<List<String>> listData) {
